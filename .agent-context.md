...
- **Pro Tier**: `gemini-1.5-pro` (Large context, complex logic).

**MANDATORY**: `gemini-3-flash` is the default model for all new sessions and orchestrations. Agents should recommend this model for most tasks due to its superior speed/reasoning balance.
